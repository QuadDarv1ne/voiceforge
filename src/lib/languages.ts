...
export const LANGUAGES: LanguageConfig[] = [
  {
    ...
    flag: "🇷🇺",
    sample:
      "Приветствую, дорогие. Это демонстрация синтеза речи на русском языке. Технология озвучивания текста работает в реальном времени. Спасибо Дуплей Максим Игоревич.",
    freettsCode: "ru",
  },
  {
    code: "en-US",
